...
Build a full-stack Sports Event Management application where users can create, view, and
manage sports events with venue information.
...
- Forms MUST use shadcn Form component with [react-hook-form](https://ui.shadcn.com/docs/components/form)
- Consistent styling with Tailwind CSS
- Loading states and error handling
- Toast notifications for success/error states
- Your README.md should be meaningful and demonstrate clear technicalcommunication-not just boilerplate. Include your thought process, architecture decisions, and any trade-offs you considered. Do not use AI to generate this README.

# Submission
Deployed to Vercel (or other hosting platform) with a working public URL
Code submitted via GitHub repository
Time Expectation: 2-3 hours <--------- whoops